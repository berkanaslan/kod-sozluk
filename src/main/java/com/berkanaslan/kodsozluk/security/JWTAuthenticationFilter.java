...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    static String createToken(Principal principal) {
        return Jwts.builder().setSubject(principal.getJwtString()).setExpiration(new Date(System.currentTimeMillis() + ConfigurationConstants.TOKEN_EXPIRATION_TIME)).signWith(SignatureAlgorithm.HS512, ConfigurationConstants.SECRET).compact();
    }
